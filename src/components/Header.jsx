  ...
  return (
    <div className="bg-[#FFFFFF]">
      <div className="max-w-[90%] mx-auto py-3 flex items-center justify-between font-inter">
        {/* Logo */}
        <div>
          <h1 className="text-[2.5rem] font-bold text-[#000] hover:text-[#87CEEB] ">
            BOOPATHI.M
          </h1>
        </div>
        ...
        >
          <ul className="flex flex-col gap-3 lg:flex-row lg:items-center lg:gap-5 text-[14px] font-semibold">
           ...
           <li className="hover:text-[#87CEEB] cursor-pointer transition-transform duration-300 ease-in transform hover:translate-y-[-7px] ">
              Home
            </li></Link>
